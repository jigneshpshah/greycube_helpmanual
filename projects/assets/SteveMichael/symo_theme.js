...
$(document).ready(function() {
    ...
    $('.btn-request').click(function() {
        ...
        // all mandatory
        if (!(args.email)) {
            msgprint("Email is required. Please try again.");
            return;
        }
		...
		if (r.message == 'okay'){msgprint('Thanks! for showing interest')}else{
                msgprint(r.message)};
